...
def get_metrics(args):
    ...
    test_real = pd.read_csv(join(args.output_dir, "test_realy.csv"), index_col=0, parse_dates=True)
    test_pred = pd.read_csv(join(args.output_dir, "test_predy.csv"), index_col=0, parse_dates=True)
