...
MIN_PEAKS        = 2      # skip if fewer peaks detected
...
def plot_hydrograph_samples(result, n_samples=5):
...
if __name__ == "__main__":
    print("=" * 65)
    print("Phase error analysis — Graph WaveNet multivariate forecasting")
