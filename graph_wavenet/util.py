...
def get_shared_arg_parser():
    ...
    parser.add_argument('--adjdata', type=str, default='data/adj/adj_mx.npy',
                        help='adj data path')
    ...
    parser.add_argument('--data', type=str, default='data/data_12H/data_12', help='data path')
    parser.add_argument('--save', type=str, default="experiment_12H_12", help='save path')
    parser.add_argument('--seq_length', type=int, default=12, help='') # need to change this
    parser.add_argument("--shift", type=int, default=12, help="Default is seq_length_x", ) # this is the window shift
    parser.add_argument('--nhid', type=int, default=100, help='Number of channels for internal conv') # Need to be optimized
    parser.add_argument('--in_dim', type=int, default=2, help='inputs dimension') # DONT DO IT. this needs to be same as in the model
