...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  3 21:04:51 2026
...
class GWNet(nn.Module):
    def __init__(self, device, num_nodes, dropout=0.3, supports=None, do_graph_conv=True,
        ...
        if self.cat_feat_gc:
            self.start_conv = nn.Conv2d(in_channels=1,  # hard code to avoid errors, try not to change this
        ...
        # Changed: The Gated TCN is a 1D temporal convolutional module to Gated TCN to 2D and it works
        ...
        for b in range(blocks):
            ...
            for i in range(layers):
                ...
                self.filter_convs.append(Conv2d(residual_channels, dilation_channels, (1, kernel_size), dilation=D)) # This was Conv1D which is not valid anymore. 
    ...
    def forward(self, x):
        ...
        for i in range(self.blocks * self.layers):
            ...
            x = filter * gate
            x = F.dropout2d(x, self.dropout, training=self.training) #### added new dropout
